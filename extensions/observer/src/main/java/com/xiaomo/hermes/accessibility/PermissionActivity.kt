...
import com.xiaomo.hermes.accessibility.databinding.ActivityObserverPermissionsBinding
...
class PermissionActivity : Activity() {
    ...
    override fun onResume() {
        ...
        sendBroadcast(android.content.Intent("com.xiaomo.hermes.PERMISSION_CHANGED"))
    ...
    private fun isAccessibilityServiceEnabled(): Boolean {
        return try {
            ...
            val serviceFull = "${packageName}/com.xiaomo.hermes.accessibility.service.PhoneAccessibilityService"

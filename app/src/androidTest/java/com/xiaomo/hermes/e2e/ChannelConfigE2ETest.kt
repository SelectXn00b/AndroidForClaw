...
class ChannelConfigE2ETest {
    ...
    fun test01_slackConfigRoundTrip() {
        ...
        val updated = original.copy(
            channels = original.channels.copy(
                slack = com.xiaomo.hermes.config.SlackChannelConfig(
                    enabled = true,
    ...
    fun test02_telegramConfigRoundTrip() {
        ...
        val updated = original.copy(
            channels = original.channels.copy(
                telegram = com.xiaomo.hermes.config.TelegramChannelConfig(
                    enabled = true,
    ...
    fun test03_whatsappConfigRoundTrip() {
        ...
        val updated = original.copy(
            channels = original.channels.copy(
                whatsapp = com.xiaomo.hermes.config.WhatsAppChannelConfig(
                    enabled = true,
    ...
    fun test04_signalConfigRoundTrip() {
        ...
        val updated = original.copy(
            channels = original.channels.copy(
                signal = com.xiaomo.hermes.config.SignalChannelConfig(
                    enabled = true,
    ...
    fun test05_allChannelsCoexist() {
        ...
        val updated = original.copy(
            channels = original.channels.copy(
                slack = com.xiaomo.hermes.config.SlackChannelConfig(enabled = true, botToken = "s1"),
                telegram = com.xiaomo.hermes.config.TelegramChannelConfig(enabled = true, botToken = "t1"),
                whatsapp = com.xiaomo.hermes.config.WhatsAppChannelConfig(enabled = true, phoneNumber = "w1"),
                signal = com.xiaomo.hermes.config.SignalChannelConfig(enabled = true, phoneNumber = "g1")
            )
        )
        configLoader.saveOpenClawConfig(updated)

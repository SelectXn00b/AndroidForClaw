...
import com.xiaomo.hermes.agent.context.PromptMode
 ...
 * 运行: ./gradlew :app:connectedDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.xiaomo.hermes.e2e.AgentLoopE2ETest
 */

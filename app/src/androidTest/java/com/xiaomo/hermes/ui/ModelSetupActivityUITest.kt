...
import com.xiaomo.hermes.ui.activity.ModelSetupActivity
 ...
 *
 * 运行:
 * adb shell am instrument -w -e class com.xiaomo.hermes.ui.ModelSetupActivityUITest \
...
class ModelSetupActivityUITest {
    ...
    fun test02_welcomeElementsDisplayed() {
        ...
        onView(withText("欢迎使用 Hermes")).check(matches(isDisplayed()))
    ...
    fun test19d_resolveProviders_fallsBackToLegacyProvidersWhenModelsProvidersEmpty() {
        val context = ApplicationProvider.getApplicationContext<android.content.Context>()
        val legacyProvider = com.xiaomo.hermes.config.ProviderConfig(
            baseUrl = "https://openrouter.ai/api/v1",
            apiKey = "test-key",
            api = "openai-completions",
            models = listOf(
                com.xiaomo.hermes.config.ModelDefinition(
        ...
        val config = com.xiaomo.hermes.config.OpenClawConfig(
            models = com.xiaomo.hermes.config.ModelsConfig(providers = emptyMap()),

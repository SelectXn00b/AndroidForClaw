...
import com.xiaomo.hermes.agent.skills.SingleTestResult
import com.xiaomo.hermes.agent.skills.TestResult
...
object ContextBuilderTestRunner {
    ...
    private fun testBuildSystemPrompt(context: Context): SingleTestResult {
        return try {
            ...
            assert(systemPrompt.contains("Hermes")) { "Should contain identity" }
    ...
    private fun testBootstrapFilesLoaded(context: Context): SingleTestResult {
        return try {
            ...
            // 应该包含 Bootstrap 文件内容
            assert(systemPrompt.contains("Hermes Agent") ||

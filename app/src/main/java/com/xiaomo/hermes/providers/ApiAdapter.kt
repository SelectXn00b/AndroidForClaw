 ...
 *
 * Hermes adaptation: provider auth/header/body request shaping.
 */
...
object ApiAdapter {
     ...
     */
    private fun buildParametersJson(params: com.xiaomo.hermes.providers.llm.ParametersSchema): JSONObject {
        val json = JSONObject()

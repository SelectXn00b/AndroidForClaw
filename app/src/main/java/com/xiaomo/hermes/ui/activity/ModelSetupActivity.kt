...
import com.xiaomo.hermes.databinding.ActivityModelSetupBinding
...
import com.xiaomo.hermes.config.ModelsConfig
...
class ModelSetupActivity : AppCompatActivity() {
    ...
    private fun saveAndFinish() {
        ...
        val apiKey = if (userInputKey.isNullOrEmpty()) {
            val builtInKey = com.xiaomo.hermes.config.BuiltInKeyProvider.getKey()
        ...
        try {
            ...
            val modelSelection = com.xiaomo.hermes.config.ModelSelectionConfig(primary = defaultModelId)
            val existingAgents = config.agents ?: com.xiaomo.hermes.config.AgentsConfig()

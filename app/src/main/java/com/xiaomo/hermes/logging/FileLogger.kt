 ...
 *
 * Hermes adaptation: file logging.
 */
package com.xiaomo.hermes.logging
...
class FileLogger(private val context: Context) {
    ...
    private val logsDir: String = com.xiaomo.hermes.workspace.StoragePaths.logs.also { it.mkdirs() }.absolutePath

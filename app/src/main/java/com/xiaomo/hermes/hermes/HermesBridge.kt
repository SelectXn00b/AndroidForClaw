    ...
    override suspend fun chatCompletion(
        ...
        val appMessages = messages.mapNotNull { msgMap ->
            ...
            val toolCalls = (msgMap["tool_calls"] as? List<*>)?.mapNotNull { tc ->
                ...
                com.xiaomo.hermes.providers.llm.ToolCall(id = id, name = fnName, arguments = fnArgs)
            }
...
object HermesBridge {
     ...
     */
    fun convertMessagesToHermes(messages: List<com.xiaomo.hermes.providers.llm.Message>): MutableList<Map<String, Any?>> {
    ...
    fun convertToolDefsToHermes(
        definitions: List<com.xiaomo.hermes.providers.ToolDefinition>,
    ): List<Map<String, Any?>> {
     ...
     */
    fun extractFinalContent(result: com.xiaomo.hermes.hermes.AgentResult): String {

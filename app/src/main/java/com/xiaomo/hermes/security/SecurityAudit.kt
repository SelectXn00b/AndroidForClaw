package com.xiaomo.hermes.security
 ...
 *
 * Hermes adaptation: runtime security audit for Android agent.
 * Checks config, tool policies, channel security, and file permissions.
 */

import com.xiaomo.hermes.config.ConfigLoader
import com.xiaomo.hermes.agent.context.ToolPolicyResolver
...
object SecurityAudit {
     ...
     */
    private fun auditConfig(config: com.xiaomo.hermes.config.OpenClawConfig?): List<SecurityAuditFinding> {
        val findings = mutableListOf<SecurityAuditFinding>()
     ...
     */
    private fun auditChannelSecurity(config: com.xiaomo.hermes.config.OpenClawConfig?): List<SecurityAuditFinding> {
        val findings = mutableListOf<SecurityAuditFinding>()
     ...
     */
    private fun auditGatewaySecurity(config: com.xiaomo.hermes.config.OpenClawConfig?): List<SecurityAuditFinding> {
        val findings = mutableListOf<SecurityAuditFinding>()

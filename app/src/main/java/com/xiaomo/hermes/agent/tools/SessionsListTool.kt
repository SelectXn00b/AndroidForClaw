 ...
 *
 * Hermes adaptation: LLM-facing tool to list subagent runs.
...
import com.xiaomo.hermes.agent.subagent.SubagentRunStatus
import com.xiaomo.hermes.agent.subagent.isActiveSubagentRun
import com.xiaomo.hermes.agent.subagent.buildIndexedList

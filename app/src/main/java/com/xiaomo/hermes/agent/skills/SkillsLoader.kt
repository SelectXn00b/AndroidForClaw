 ...
 *
 * Hermes adaptation: bundled/managed/workspace skill discovery and cache.
 */
 ...
 * 3. Managed Skills — /sdcard/.hermes/skills/
 * 4. Plugin Skills — enabled plugin skill directories
 * 5. Workspace Skills (highest) — /sdcard/.hermes/workspace/skills/
 *
...
class SkillsLoader(private val context: Context) {
    ...
    /**
     * Load managed Skills from /sdcard/.hermes/skills/
     */
    ...
    private fun loadPluginSkills(
        skills: MutableMap<String, SkillDocument>,
        config: com.xiaomo.hermes.config.OpenClawConfig
    ): Int {
        var count = 0
    ...
    /**
     * Load workspace Skills from /sdcard/.hermes/workspace/skills/
     */

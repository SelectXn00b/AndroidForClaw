...
data class SkillDocument(
     ...
     * "managed" - From /sdcard/.hermes/skills/ (aligns with ~/.openclaw/skills/)
     * "workspace" - From /sdcard/.hermes/workspace/skills/ (aligns with ~/.openclaw/workspace/)
...
enum class SkillSource(val displayName: String) {
    ...
    MANAGED("managed"),      // /sdcard/.hermes/skills/ (aligns with ~/.openclaw/skills/)
    WORKSPACE("workspace"),  // /sdcard/.hermes/workspace/skills/ (aligns with ~/.openclaw/workspace/)

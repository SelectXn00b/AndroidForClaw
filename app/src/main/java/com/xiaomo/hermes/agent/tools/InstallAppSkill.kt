...
class InstallAppSkill(private val context: Context) : Skill {
    companion object {
        ...
        private const val ACTION_INSTALL_RESULT = "com.xiaomo.hermes.INSTALL_RESULT"
                ...
                parameters = ParametersSchema(
                    ...
                    properties = mapOf(
                        "apk_path" to PropertySchema(
                            "string",
                            "APK 文件的路径，例如 '/sdcard/Download/app.apk' 或 '${com.xiaomo.hermes.workspace.StoragePaths.skills.absolutePath}/example.apk'"
                        ),

 ...
 *
 * Hermes adaptation: LLM-facing tool to display session status.
...
import com.xiaomo.hermes.agent.subagent.countActiveRunsForSession
...
import com.xiaomo.hermes.agent.subagent.resolveSubagentSessionStatus

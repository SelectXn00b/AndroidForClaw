 ...
 *
 * Hermes adaptation: unified function-call dispatcher across universal tools and Android tools.
 */

import com.xiaomo.hermes.logging.Log
import com.xiaomo.hermes.secrets.ResolveSecretRefOptions
import com.xiaomo.hermes.secrets.SecretRef
import com.xiaomo.hermes.secrets.SecretRefSource
import com.xiaomo.hermes.secrets.DEFAULT_SECRET_PROVIDER_ALIAS
import com.xiaomo.hermes.secrets.resolveSecretRefValues

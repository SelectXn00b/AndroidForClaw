 ...
 *
 * Hermes adaptation: per-channel, per-chatType history turn limiting.
...
object HistoryTurnLimiter {
    ...
    private fun getChannelHistoryLimit(config: Any): Int? {
        return when (config) {
            is com.xiaomo.hermes.config.FeishuChannelConfig -> config.historyLimit
            is com.xiaomo.hermes.config.TelegramChannelConfig -> config.historyLimit
            is com.xiaomo.hermes.config.DiscordChannelConfig -> config.historyLimit
            is com.xiaomo.hermes.config.SlackChannelConfig -> config.historyLimit
            is com.xiaomo.hermes.config.WhatsAppChannelConfig -> config.historyLimit
            is com.xiaomo.hermes.config.SignalChannelConfig -> config.historyLimit
            else -> null
        }
    }
    ...
    private fun getChannelDmHistoryLimit(config: Any): Int? {
        return when (config) {
            is com.xiaomo.hermes.config.FeishuChannelConfig -> config.dmHistoryLimit
            is com.xiaomo.hermes.config.TelegramChannelConfig -> config.dmHistoryLimit
            is com.xiaomo.hermes.config.DiscordChannelConfig -> config.dmHistoryLimit
            is com.xiaomo.hermes.config.SlackChannelConfig -> config.dmHistoryLimit
            is com.xiaomo.hermes.config.WhatsAppChannelConfig -> config.dmHistoryLimit
            is com.xiaomo.hermes.config.SignalChannelConfig -> config.dmHistoryLimit
            else -> null
        }
    }
}

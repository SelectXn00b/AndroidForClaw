...
class SkillStatusBuilder(private val context: Context) {
     ...
     *
     * @param workspacePath Workspace path (default: /sdcard/.hermes/workspace)
     ...
     */
    private fun getConfigValue(path: String, config: com.xiaomo.hermes.config.OpenClawConfig): Any? {

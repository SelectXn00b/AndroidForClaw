...
import com.xiaomo.hermes.routing.SessionKeyShape
import com.xiaomo.hermes.routing.classifySessionKeyShape
import com.xiaomo.hermes.routing.parseRawSessionConversationRef
 ...
 *
 * Hermes adaptation: session key utilities for group/DM distinction.
 *
...
object SessionKeyUtils {
     ...
     */
    @Deprecated(
        message = "Use com.xiaomo.hermes.routing.normalizeMainKey() instead",
        replaceWith = ReplaceWith(
            "com.xiaomo.hermes.routing.normalizeMainKey(raw)",
            "com.xiaomo.hermes.routing.normalizeMainKey"
        )
    )
    fun normalizeMainKey(raw: String?): String {
        return com.xiaomo.hermes.routing.normalizeMainKey(raw)
    }
     ...
     */
    @Deprecated(
        message = "Use com.xiaomo.hermes.routing.classifySessionKeyShape() instead",
        replaceWith = ReplaceWith(
            "classifySessionKeyShape(raw) in setOf(SessionKeyShape.AGENT, SessionKeyShape.LEGACY_OR_ALIAS)",
            "com.xiaomo.hermes.routing.classifySessionKeyShape",
            "com.xiaomo.hermes.routing.SessionKeyShape"
        )
    )
     ...
     */
    @Deprecated(
        message = "Use com.xiaomo.hermes.routing.parseRawSessionConversationRef() instead",
        replaceWith = ReplaceWith(
            "parseRawSessionConversationRef(sessionKey)?.kind == \"group\"",
            "com.xiaomo.hermes.routing.parseRawSessionConversationRef"
        )
    )

...
<title>Hermes - Web Clipboard</title>
<style>
...
loadHistory();
    ...
    inner class GatewayWebSocket(
        ...
        private fun handleChannelRestart(): JSONObject {
            val app = context.applicationContext as? com.xiaomo.hermes.core.MyApplication
            if (app != null) {
        ...
        private fun handleChatSend(params: JSONObject?): JSONObject {
            ...
            val adbCommand = if (sessionId.isNotEmpty()) {
                "adb shell am broadcast -a com.xiaomo.hermes.ACTION_EXECUTE_AGENT --es message \"$message\" --es sessionId \"$sessionId\""
            } else {
                "adb shell am broadcast -a com.xiaomo.hermes.ACTION_EXECUTE_AGENT --es message \"$message\""
            }
            ...
            try {
                ...
                val intent = android.content.Intent("com.xiaomo.hermes.ACTION_EXECUTE_AGENT").apply {

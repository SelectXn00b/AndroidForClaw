package com.xiaomo.hermes.sessions

/**
 * OpenClaw Source Reference:
 * - ../openclaw/src/sessions/send-policy.ts
 *
 * Hermes adaptation: session send-policy resolution.
 *
 * Uses [com.xiaomo.hermes.config.OpenClawConfig] for config access.
...
fun resolveSendPolicy(
    ...
    // OpenClaw: cfg.session?.sendPolicy — Hermes SessionConfig doesn't have sendPolicy yet,
 ...
 *
 * Since [com.xiaomo.hermes.config.SessionConfig] may not yet declare

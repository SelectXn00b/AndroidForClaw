...
class TermuxEntryVisibilityTest {
    ...
    fun settingsTab_containsTermuxEntry() {
        val candidates = listOf(
            "src/main/java/com/xiaomo/androidforclaw/ui/compose/ForClawSettingsTab.kt",
        ...
        val file = candidates.map { File(it) }.firstOrNull { it.exists() }
            ?: throw AssertionError("ForClawSettingsTab.kt not found, cwd=${System.getProperty("user.dir")}")
